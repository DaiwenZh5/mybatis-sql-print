...
public class SqlFormatter {
    ...
    static final String INDENT_SIGN = "\t";
    static final String INITIAL = "";
    private final Set<String> BEGIN_CLAUSES = new HashSet<>();
    private final Set<String> END_CLAUSES = new HashSet<>();
    private final Set<String> LOGICAL = new HashSet<>();
    private final Set<String> QUANTIFIERS = new HashSet<>();
    private final Set<String> DML = new HashSet<>();
    private final Set<String> MISC = new HashSet<>();
    ...
    public String format(String source) {
        return new FormatProcess(source.trim()).perform();
    }
    ...
    private static class FormatProcess {
        ...
        public String perform() {
            ...
            while (this.tokens.hasMoreTokens()) {
                ...
                if ((this.afterSelect) && ("," .equals(this.token))) {
                    commaAfterSelect();
        ...
        private void newline() {
            ...
            for (int i = 0; i < this.indent; i++) {
                this.result.append(INDENT_SIGN);
            }
            this.beginLine = true;
        }
    }
